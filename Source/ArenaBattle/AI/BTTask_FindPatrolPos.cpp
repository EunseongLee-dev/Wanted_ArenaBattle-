...
EBTNodeResult::Type UBTTask_FindPatrolPos::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	// 구현 목표: 다음에 정찰할 위치를 선택
	// 1. 블랙보드에 HomePos위치를 기준으로 일정 반경 안에서 랜덤 위치 선택
	...
	bool bResult = NavSystem->GetRandomPointInNavigableRadius(Origin, PartrolRadius, NextPatrolPos);
